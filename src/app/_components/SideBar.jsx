...
export default function DashboardSuperAdmin() {
  ...
  return (
    <>
<div className="relative flex flex-col bg-clip-border backdrop-blur-lg bg-black/30 text-gray-700 h-[calc(100vh-2rem)] w-full max-w-[20rem] p-4 shadow-xl shadow-blue-gray-900/5 ">
  <div className="mb-2 p-4">
    <h5 className="block antialiased tracking-normal font-sans text-xl font-semibold leading-snug text-[#D0E153]">Dashbord Super admin</h5>
  </div>
