  ...
  return (
    <div className="h-screen w-full bg-gray-50 flex justify-center items-center">
      <div className="h-56 w-72 absolute flex justify-center items-center">
        <img
          className="object-cover h-20 w-20 rounded-full z-30"
          ...
          alt=""
        //   src={`https://ui-avatars.com/api/?name=${admin.name}&background=random`} alt={admin.name}
        />
      </div>

      <div className="h-56 mx-4 w-5/6 bg-blue-950 rounded-3xl shadow-md sm:w-80 sm:mx-0">
