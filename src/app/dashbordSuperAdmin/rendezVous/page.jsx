  ...
  return (
    <div className="text-gray-900 ">
      <div className="p-4 flex">
        <h1 className="mt-14 text-2xl font-bold pb-9 sm:p-2 ">Rendez-vous</h1>
      </div>
        ...
        <table className="w-full text-md bg-white shadow-md rounded mb-4">
          <tbody>
            <tr className="border-b">
              ...
              <th className="text-left p-3 px-5">Type de rendez-vous</th>
              <th className="text-left p-3 px-5"></th>
              <th></th>
            </tr>
            <tr className="border-b hover:bg-[#d0e15394] bg-gray-100">
