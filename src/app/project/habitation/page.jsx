        ...
        <section className="pb-20 pt-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px] ">
            <div className="container mx-auto ">
                <Swiper slidesPerView={1} ref={sliderRef}>
                    <SwiperSlide>
                        <SingleTestimonial
                            image="/img-projet/img-maison.jpg"
                            reviewImg="Assurance habitation"
                            reviewAlt="Photo d'une maison avec un jardin bien entretenu"
                            details="Ce projet a pour objectif de garantir la protection des maisons et des biens immobiliers de nos clients. Il comprend des polices d'assurance pour les propriétés résidentielles, les appartements, les copropriétés, etc."
