  ...
  return (
    <section className="pb-20 pt-20 dark:bg-dark lg:pb-[120px] lg:pt-[120px] ">
      <div className="container mx-auto ">
        ...
        <SwiperSlide>
            <SingleTestimonial
              image="/img-projet/img-sante.jpg"
              reviewImg="Assurance santé"
              reviewAlt="Photo d'une personne en train de consulter un médecin"
              details="Ce projet a pour but de fournir une couverture santé complète à nos clients. Il comprend des polices d'assurance maladie, des assurances dentaires, des assurances vision, etc."
